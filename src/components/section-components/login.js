            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="section-title-area text-center">
                  ...
                  <p>
                    Invest in new properties and manage your current
                    investments.
                  </p>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="account-create text-center pt-50">
                  ...
                  <p>
                    Add items to your wishlist and get personalised
                    recommendations <br />
                    check out more quickly and track your properties by
                    registering to Tsigiro.
                  </p>
