              ...
              <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                ...
                <div className="ltn__feature-info">
                  ...
                  <p>
                    ...
                    access to great property deals, in-depth analysis, and a
                    community of wealth builders.
                  </p>
                  <Link className="ltn__service-btn" to="/properties">
                    Buy Now <i className="flaticon-right-arrow" />
                  </Link>
                </div>
              </div>
            </div>
              ...
              <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1 active">
                ...
                <div className="ltn__feature-info">
                  ...
                  <p>
                    ...
                    leaving your living room. No experience, connections, or
                    down payments required.
                  </p>
                  <Link className="ltn__service-btn" to="/investing">
                    Invest Now <i className="flaticon-right-arrow" />
                  </Link>
                </div>
              </div>
            </div>
