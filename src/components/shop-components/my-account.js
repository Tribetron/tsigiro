...
import RequestList from "../functional-components/RequestList";
...
class MyAccount extends Component {
  render() {
    ...
    return (
      <div className="liton__wishlist-area pb-70" style={{ marginTop: 50 }}>
                    ...
                    <div className="col-lg-4">
                      <div className="ltn__tab-menu-list mb-50">
                        <div className="nav">
                          ...
                          <a data-bs-toggle="tab" href="#purchase-tracker">
                            Property Purchase Tracker{" "}
                            <i className="fa fa-thumb-tack" />
                          </a>
                          <a data-bs-toggle="tab" href="#ltn_tab_1_2">
                            Transactions <i class="fa fa-credit-card" />
                          </a>
                          <a data-bs-toggle="tab" href="#ltn_tab_1_2">
                            Billing Settings
