...
const ProductSliderV1 = (dataSource) => {
        ...
        <div className="row ltn__image-slider-5-active slick-arrow-1 slick-arrow-1-inner ltn__no-gutter-all">
          <div className="col-lg-12">
            <div className="ltn__img-slide-item-4">
              ...
              >
                <img src={dataSource.data[0].url} alt="Image" />
              </a>
            </div>
          </div>
          <div className="col-lg-12">
            <div className="ltn__img-slide-item-4">
              <a
                ...
                data-rel="lightcase:myCollection"
              >
                <img src={dataSource.data[1].url} alt="Image" />
              </a>
            </div>
          </div>
          <div className="col-lg-12">
            <div className="ltn__img-slide-item-4">
              <a
                ...
                data-rel="lightcase:myCollection"
              >
                <img src={dataSource.data[2].url} alt="Image" />
              </a>
            </div>
          </div>
          <div className="col-lg-12">
            <div className="ltn__img-slide-item-4">
              <a
                ...
                data-rel="lightcase:myCollection"
              >
                <img src={dataSource.data[3].url} alt="Image" />
              </a>
            </div>
          </div>
        </div>
